<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ItemMaster.aspx.vb" Inherits="GRIDVIEW_CRUD.ItemMaster" %>
        ...
        <table style="width:100%;">
            <tr>
                <td>
                    ...
                    <asp:GridView ID="GV_SALES" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" 
                        BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" Width="100%" ShowFooter="True" OnDataBound="OnDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Item">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_item" runat="server" Text='<%# Bind("ItemName") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:DropDownList ID="ddl_item" runat="server" Width="98%"></asp:DropDownList>
                                </FooterTemplate>
                                <EditItemTemplate>
                                    <asp:DropDownList ID="ddl_Edititem" runat="server" Width="98%"></asp:DropDownList>
                                    <asp:Label ID="lbl_Edititem" Visible="false" runat="server" Text='<%# Bind("Item") %>'></asp:Label>
                                </EditItemTemplate>
                            </asp:TemplateField>
